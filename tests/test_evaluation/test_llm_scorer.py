        ...
        if response_model == SynthesisScoreResult:
            return LLMStructuredResponse(
                parsed=SynthesisScoreResult(
                    generated_score=3.8,
                    reference_score=4.2,
                    dimension_scores_generated={
                        "cross_paper": 3.5,
                        "contradiction_handling": 4.0,
                        "gap_identification": 3.5,
                        "evidence_weighting": 4.0,
                        "narrative_coherence": 3.5,
                    },
                    dimension_scores_reference={
                        "cross_paper": 4.0,
                        "contradiction_handling": 4.5,
                        "gap_identification": 4.0,
                        "evidence_weighting": 4.0,
                        "narrative_coherence": 4.5,
                    },
                    generated_observations="Good.",
            ...
            return LLMStructuredResponse(
                parsed=WritingQualityResult(
                    ...
                    dimension_scores_generated={
                        "clarity": 3.5,
                        "coherence": 3.5,
                        "academic_register": 3.5,
                        "flow": 3.5,
                    },
                    dimension_scores_reference={
                        "clarity": 4.0,
                        "coherence": 4.0,
                        "academic_register": 4.0,
                        "flow": 4.0,
                    },
