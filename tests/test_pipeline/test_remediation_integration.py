                ...
                return LLMStructuredResponse(
                    parsed=QueryCoverageResult(
                        sub_topic_assessments=[
                            SubTopicCoverage(
                                sub_topic="Topic A", covered=True, matching_queries=["q"]
                            ),
                            SubTopicCoverage(
                                sub_topic="Topic B", covered=True, matching_queries=["q"]
                            ),
                            SubTopicCoverage(
                                sub_topic="Topic C", covered=False, matching_queries=[]
                            ),
                        ],
                ...
                return LLMStructuredResponse(
                    parsed=QueryCoverageResult(
                        sub_topic_assessments=[
                            ...
                            SubTopicCoverage(
                                sub_topic="Topic C", covered=True, matching_queries=["q"]
                            ),
                        ],
